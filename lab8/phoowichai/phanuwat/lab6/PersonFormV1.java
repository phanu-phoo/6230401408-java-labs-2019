...
public class PersonFormV1 extends MySimpleWindow {
	...
	protected JLabel labelName, labelHeight, labelWeight, labelDoB, labelType;
    protected JTextField tfName, tfHeight, tfWeight, tfDoB;
    protected JRadioButton radioStd, radioTch;
